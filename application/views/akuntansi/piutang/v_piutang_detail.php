            ...
            <div class="modal-body">
                <form id="submit">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control tanggal" name="tanggal" autocomplete="off" readonly required value="<?= date("Y-m-d"); ?>">
...
<script>
    ...
    function relasi_list() {
        $.ajax({
            type: 'ajax',
            url: "<?php echo base_url() ?>index.php/akuntansi/piutang/detail_list_hutang?id=<?= $this->uri->segment('4') ?>",
            async: false,
            dataType: 'json',
            success: function(data) {
                ...
                if (data.length === 0) {
                    ...
                    for (i = 0; i < data.length; i++) {
                        total_hutang += parseInt(data[i].PIUTANG_DEBET) - parseInt(data[i].PIUTANG_KREDIT)
