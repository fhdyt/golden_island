...
<script>
    ...
    $('#submit').submit(function(e) {
        e.preventDefault();
        $.ajax({
            url: '<?php echo base_url(); ?>index.php/penjualan/surat_jalan/add',
            type: "post",
            ...
            success: function(data) {
                window.location.href = '<?= base_url(); ?>penjualan/surat_jalan/form/<?= $id; ?>/'
    ...
    function detail() {
        $.ajax({
            type: 'ajax',
            url: '<?php echo base_url() ?>index.php/penjualan/surat_jalan/detail/<?= $id; ?>',
            async: false,
            dataType: 'json',
            success: function(data) {
                memuat()
    ...
    function detail_jenis_barang() {
        $.ajax({
            type: 'ajax',
            url: "<?php echo base_url() ?>index.php/penjualan/surat_jalan/detail_jenis_barang?jenis=" + $(".jenis").val(),
            async: false,
            dataType: 'json',
            success: function(data) {
    ...
    $('.btn-add-barang-isi').on("click", function(e) {
        $.ajax({
            type: "POST",
            url: '<?php echo base_url(); ?>index.php/penjualan/surat_jalan/add_barang',
            dataType: "JSON",
            beforeSend: function() {
                memuat()
            },
    ...
    function barang_list() {
        $.ajax({
            type: 'ajax',
            url: "<?php echo base_url() ?>index.php/penjualan/surat_jalan/list_barang/<?= $id; ?>",
            async: false,
            dataType: 'json',
            success: function(data) {
    ...
    function hapus(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: 'ajax',
                    url: '<?php echo base_url() ?>index.php/penjualan/surat_jalan/hapus/' + id,
                    dataType: 'json',
                    success: function(data) {
                        if (data.length === 0) {} else {
