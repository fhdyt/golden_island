                ...
                <form id="submitbarang">
                    ...
                    <div class="form-group">
                        ...
                        <select name="jenis_barang" id="jenis_barang" class="form-control">
                            ...
                            ?>
                                <option value="<?= $row->MASTER_JENIS_BARANG_ID; ?>"><?= $row->MASTER_JENIS_BARANG_NAMA; ?></option>
                            <?php
                            }
                            ?>
                        </select>
            ...
            <div class="card card-default color-palette-box">
                <div class="card-body">
                    <form id="submit">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <button type="button" class="btn btn-success btn_barang mb-2 btn-sm">Tambah Barang</button>
