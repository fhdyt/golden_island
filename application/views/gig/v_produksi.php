...
<script>
    ...
    function produksi_list() {
        $.ajax({
            type: 'POST',
            url: "<?php echo base_url() ?>index.php/gig/produksi/list",
            async: false,
            dataType: 'json',
            data: {
                bulan: $(".bulan").val(),
            ...
            success: function(data) {
                ...
                if (data.length === 0) {
                    ...
                    $("tbody#zone_data_total").append('<tr><td colspan="6" style="text-align:right">Total</td><td>' + total_gl + '</td><td>' + total_terpakai + '</td><td>' + total_tabung + '</td></tr>')
                }
            },
            error: function(x, e) {
                console.log("Gagal")
