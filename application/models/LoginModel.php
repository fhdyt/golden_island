...
class LoginModel extends CI_Model
{
  ...
  public function menu()
  {
    ...
    AND APLIKASI.RECORD_STATUS="AKTIF" GROUP BY APLIKASI.APLIKASI_ID, APLIKASI.APLIKASI_NAMA, APLIKASI.APLIKASI_ICON, APLIKASI.APLIKASI_LINK')->result();
